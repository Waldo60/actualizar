...
source <(curl -sL https://raw.githubusercontent.com/Waldo60/ocho/master/ArchivosUtilitarios/V2RAY/install.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/Waldo60/ocho/master/ArchivosUtilitarios/V2RAY/install.sh) --remove
}
infocuenta () {
v2ray info
}
